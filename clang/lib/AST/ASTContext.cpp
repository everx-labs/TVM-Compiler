...
// TVM local begin
BuiltinTemplateDecl *ASTContext::getReflectFieldDecl() const {
  if (!ReflectFieldDecl)
    ReflectFieldDecl =
        buildBuiltinTemplateDecl(BTK__reflect_field, getReflectFieldName());
  return ReflectFieldDecl;
}

BuiltinTemplateDecl *ASTContext::getReflectFieldsCountDecl() const {
  if (!ReflectFieldsCountDecl)
    ReflectFieldsCountDecl = buildBuiltinTemplateDecl(
        BTK__reflect_fields_count, getReflectFieldsCountName());
  return ReflectFieldsCountDecl;
}

BuiltinTemplateDecl *ASTContext::getReflectMethodsCountDecl() const {
...
BuiltinTemplateDecl *ASTContext::getReflectMethodNameDecl() const {
...
BuiltinTemplateDecl *ASTContext::getReflectMethodPtrNameDecl() const {
...
BuiltinTemplateDecl *ASTContext::getReflectReturnNameDecl() const {
...
BuiltinTemplateDecl *ASTContext::getReflectMethodFuncIdDecl() const {
...
BuiltinTemplateDecl *ASTContext::getReflectMethodInternalDecl() const {
...
BuiltinTemplateDecl *ASTContext::getReflectMethodPtrInternalDecl() const {
...
BuiltinTemplateDecl *ASTContext::getReflectMethodAnswerIdDecl() const {
...
BuiltinTemplateDecl *ASTContext::getReflectMethodPtrAnswerIdDecl() const {
...
BuiltinTemplateDecl *ASTContext::getReflectMethodExternalDecl() const {
...
BuiltinTemplateDecl *ASTContext::getReflectMethodGetterDecl() const {
  if (!ReflectMethodGetterDecl)
    ReflectMethodGetterDecl = buildBuiltinTemplateDecl(
        BTK__reflect_method_getter, getReflectMethodGetterName());
  return ReflectMethodGetterDecl;
}

BuiltinTemplateDecl *ASTContext::getReflectMethodNoAcceptDecl() const {
...
BuiltinTemplateDecl *ASTContext::getReflectMethodImplicitFuncIdDecl() const {
  if (!ReflectMethodImplicitFuncIdDecl)
    ReflectMethodImplicitFuncIdDecl =
        buildBuiltinTemplateDecl(BTK__reflect_method_implicit_func_id,
                                 getReflectMethodImplicitFuncIdName());
  return ReflectMethodImplicitFuncIdDecl;
}

BuiltinTemplateDecl *ASTContext::getReflectMethodDynChainParseDecl() const {
  if (!ReflectMethodDynChainParseDecl)
    ReflectMethodDynChainParseDecl =
        buildBuiltinTemplateDecl(BTK__reflect_method_dyn_chain_parse,
                                 getReflectMethodDynChainParseName());
...
BuiltinTemplateDecl *ASTContext::getReflectMethodNoReadPersistentDecl() const {
  if (!ReflectMethodNoReadPersistentDecl)
    ReflectMethodNoReadPersistentDecl =
        buildBuiltinTemplateDecl(BTK__reflect_method_no_read_persistent,
                                 getReflectMethodNoReadPersistentName());
  return ReflectMethodNoReadPersistentDecl;
}

BuiltinTemplateDecl *ASTContext::getReflectMethodNoWritePersistentDecl() const {
  if (!ReflectMethodNoWritePersistentDecl)
    ReflectMethodNoWritePersistentDecl =
        buildBuiltinTemplateDecl(BTK__reflect_method_no_write_persistent,
                                 getReflectMethodNoWritePersistentName());
  return ReflectMethodNoWritePersistentDecl;
}

BuiltinTemplateDecl *ASTContext::getReflectMethodPtrFuncIdDecl() const {
...
BuiltinTemplateDecl *ASTContext::getReflectMethodRvDecl() const {
...
BuiltinTemplateDecl *ASTContext::getReflectMethodPtrRvDecl() const {
...
BuiltinTemplateDecl *ASTContext::getReflectMethodArgStructDecl() const {
...
BuiltinTemplateDecl *ASTContext::getReflectMethodPtrArgStructDecl() const {
...
BuiltinTemplateDecl *ASTContext::getReflectSmartInterfaceDecl() const {
...
BuiltinTemplateDecl *ASTContext::getReflectProxyDecl() const {
  if (!ReflectProxyDecl)
    ReflectProxyDecl =
        buildBuiltinTemplateDecl(BTK__reflect_proxy, getReflectProxyName());
  return ReflectProxyDecl;
}

BuiltinTemplateDecl *ASTContext::getReflectMethodPtrDecl() const {
  if (!ReflectMethodPtrDecl)
    ReflectMethodPtrDecl = buildBuiltinTemplateDecl(BTK__reflect_method_ptr,
                                                    getReflectMethodPtrName());
  return ReflectMethodPtrDecl;
}

BuiltinTemplateDecl *ASTContext::getReflectInterfaceHasPubkeyDecl() const {
...
BuiltinTemplateDecl *ASTContext::getReflectInterfaceHasTimestampDecl() const {
  if (!ReflectInterfaceHasTimestampDecl)
    ReflectInterfaceHasTimestampDecl =
        buildBuiltinTemplateDecl(BTK__reflect_interface_has_timestamp,
                                 getReflectInterfaceHasTimestampName());
  return ReflectInterfaceHasTimestampDecl;
}

BuiltinTemplateDecl *ASTContext::getReflectInterfaceHasExpireDecl() const {
...
BuiltinTemplateDecl *ASTContext::getReflectSignatureFuncIdDecl() const {
...
BuiltinTemplateDecl *ASTContext::getReflectEchoDecl() const {
  if (!ReflectEchoDecl)
    ReflectEchoDecl =
        buildBuiltinTemplateDecl(BTK__reflect_echo, getReflectEchoName());
...
QualType ASTContext::getSplatStructType(QualType ElemType, unsigned NumFields,
  ...
  for (unsigned i = 0; i < NumFields; ++i) {
    ...
    FieldDecl *Field =
        FieldDecl::Create(*this, RecDecl, SourceLocation(), SourceLocation(),
                          &Idents.get(fName), ElemType, /*TInfo=*/nullptr,
                          /*BitWidth=*/nullptr,
...
QualType ASTContext::prepareTVMTuplePopStructType(StringRef StructName) const {
  ...
  FieldDecl *Field0 =
      FieldDecl::Create(*this, RecDecl, SourceLocation(), SourceLocation(),
                        &Idents.get("tuple"), TVMTupleTy, /*TInfo=*/nullptr,
                        /*BitWidth=*/nullptr,
                        /*Mutable=*/false, ICIS_NoInit);
  ...
  FieldDecl *Field1 =
      FieldDecl::Create(*this, RecDecl, SourceLocation(), SourceLocation(),
                        &Idents.get("value"), IntTy, /*TInfo=*/nullptr,
                        /*BitWidth=*/nullptr,
                        /*Mutable=*/false, ICIS_NoInit);
...
QualType ASTContext::prepareTVMLiteralStructType(ArrayRef<QualType> Elems,
  ...
  for (unsigned i = 0, sz = Elems.size(); i < sz; ++i) {
    QualType Ty = Elems[i];
    FieldDecl *F = FieldDecl::Create(
        *this, RecDecl, SourceLocation(), SourceLocation(),
        &Idents.get(Name + std::to_string(i)), Ty, /*TInfo=*/nullptr,
        /*BitWidth=*/nullptr,
        /*Mutable=*/false, ICIS_NoInit);
...
QualType ASTContext::getTVMArgumentsStructType(const CXXMethodDecl *Method,
  ...
  [[maybe_unused]] auto [It, Ok] =
      TVMMethodArgStructs.insert(std::make_pair(Method, ArgTy));
  assert(Ok && "can't update TVMMethodArgStructs");
  return ArgTy;
}

/// Creating struct with combined arguments for Method (no `this`)
QualType ASTContext::prepareTVMArgumentsStructType(const CXXMethodDecl *Method,
                                                   SourceLocation Loc) const {
  ...
  for (auto Param : Method->parameters()) {
    ...
    FieldDecl *F = FieldDecl::Create(*this, RecDecl, Loc, Loc,
                                     &Idents.get(Param->getName()), FieldType,
                                     /*TInfo=*/nullptr,
                                     /*BitWidth=*/nullptr,
                                     /*Mutable=*/false, ICIS_NoInit);
    F->setAccess(AS_public);
...
static QualType DecodeTypeFromStr(const char *&Str, const ASTContext &Context,
 ...
 // TVM local begin
  ...
  if (Str[0] == 'T') {
    ...
    case 's':
      Str += 2;
      return Context.TVMSliceTy;
    case 'b':
      Str += 2;
      return Context.TVMBuilderTy;
    case 'c':
      Str += 2;
      return Context.TVMCellTy;
    case 't':
      Str += 2;
      return Context.TVMTupleTy;
    case 'p':
      Str += 2;
      return Context.getTVMTuplePop();
    }
    if (isdigit(Str[1])) {
      char *End;
