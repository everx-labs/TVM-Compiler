...
ASTFileSignature ASTWriter::WriteASTCore(Sema &SemaRef, StringRef isysroot,
  ...
  // TVM local begin
  RegisterPredefDecl(Context.ReflectFieldDecl, PREDEF_DECL_REFLECT_FIELD_ID);
  ...
  RegisterPredefDecl(Context.ReflectProxyDecl, PREDEF_DECL_REFLECT_PROXY_ID);
  ...
  RegisterPredefDecl(Context.ReflectEchoDecl, PREDEF_DECL_REFLECT_ECHO_ID);
  // TVM local end
