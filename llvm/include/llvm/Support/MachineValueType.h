...
namespace llvm {
  ...
  public:
    enum SimpleValueType : uint8_t {
      ...
      // TVM local begin
      i256           =   8,   // This is a tvm 256 bit integer value
      i257           =   9,   // This is a tvm 257 bit signed integer value

      FIRST_INTEGER_VALUETYPE = i1,
      LAST_INTEGER_VALUETYPE  = i257,
      ...
      TVMSlice       = 181,    // TVM's slice type
      TVMBuilder     = 182,    // TVM's builder type
      TVMCell        = 183,    // TVM's cell type
      TVMTuple       = 184,    // TVM's tuple type

      FIRST_VALUETYPE =  1,    // This is always the beginning of the list.
      LAST_VALUETYPE = TVMTuple,  // This always remains at the end of the list.
