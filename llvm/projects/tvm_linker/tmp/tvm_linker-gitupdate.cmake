...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'E:/Temp/TON-Compiler-LLVM13/llvm/projects/ton-compiler/tvm_linker/src/tvm_linker'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'E:/Temp/TON-Compiler-LLVM13/llvm/projects/ton-compiler/tvm_linker/src/tvm_linker'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
