; RUN: llc < %s -march=tvm 
; ModuleID = 'dowhile_for_dowhile.c'
source_filename = "dowhile_for_dowhile.c"
...
do.body.us:                                       ; preds = %entry, %for.cond.for.cond.cleanup_crit_edge.us
  %res.0.us = phi i257 [ %add.us, %for.cond.for.cond.cleanup_crit_edge.us ], [ 0, %entry ]
  %v1.0.us = phi i257 [ %inc4.us, %for.cond.for.cond.cleanup_crit_edge.us ], [ 0, %entry ]
...
do.end.us:                                        ; preds = %do.body1.us
  ...
  br i1 %cmp.us, label %do.body1.preheader.us, label %for.cond.for.cond.cleanup_crit_edge.us
...
do.end7:                                          ; preds = %for.cond.for.cond.cleanup_crit_edge.us, %entry
  %res.1.lcssa.lcssa = phi i257 [ 0, %entry ], [ %add.us, %for.cond.for.cond.cleanup_crit_edge.us ]
