; RUN: llc < %s -march=tvm 
; ModuleID = 'while_dowhile_for.c'
source_filename = "while_dowhile_for.c"
...
entry:
  ...
  br i1 %or.cond, label %do.body.preheader.us, label %while.end
...
do.body.us.us:                                    ; preds = %do.body.preheader.us, %for.cond.for.cond.cleanup_crit_edge.us.us
  %res.1.us.us = phi i257 [ %add.us.us, %for.cond.for.cond.cleanup_crit_edge.us.us ], [ %res.020.us, %do.body.preheader.us ]
  %v2.0.us.us = phi i257 [ %inc2.us.us, %for.cond.for.cond.cleanup_crit_edge.us.us ], [ 0, %do.body.preheader.us ]
...
for.body.us.us:                                   ; preds = %for.body.us.us, %do.body.us.us
  %v3.018.us.us = phi i257 [ 0, %do.body.us.us ], [ %inc.us.us, %for.body.us.us ]
  %res.217.us.us = phi i257 [ %res.1.us.us, %do.body.us.us ], [ %add.us.us, %for.body.us.us ]
...
do.end.us-lcssa.us.us:                            ; preds = %for.cond.for.cond.cleanup_crit_edge.us.us
  ...
  br i1 %cmp.us, label %do.body.preheader.us, label %while.end

while.end:                                        ; preds = %do.end.us-lcssa.us.us, %entry
