; RUN: llc < %s -march=tvm 
; ModuleID = 'while_for_dowhile.c'
source_filename = "while_for_dowhile.c"
...
entry:
  ...
  br i1 %or.cond, label %for.cond.preheader.us, label %while.end

for.cond.preheader.us:                            ; preds = %entry, %for.cond.for.cond.cleanup_crit_edge.us
  %v1.021.us = phi i257 [ %inc4.us, %for.cond.for.cond.cleanup_crit_edge.us ], [ 0, %entry ]
  %res.020.us = phi i257 [ %add.us, %for.cond.for.cond.cleanup_crit_edge.us ], [ 0, %entry ]
...
do.end.us:                                        ; preds = %do.body.us
  ...
  br i1 %cmp1.us, label %do.body.preheader.us, label %for.cond.for.cond.cleanup_crit_edge.us

do.body.preheader.us:                             ; preds = %for.cond.preheader.us, %do.end.us
  %v2.018.us = phi i257 [ 0, %for.cond.preheader.us ], [ %inc3.us, %do.end.us ]
  %res.117.us = phi i257 [ %res.020.us, %for.cond.preheader.us ], [ %add.us, %do.end.us ]
  br label %do.body.us

for.cond.for.cond.cleanup_crit_edge.us:           ; preds = %do.end.us
...
while.end:                                        ; preds = %for.cond.for.cond.cleanup_crit_edge.us, %entry
  %res.0.lcssa = phi i257 [ 0, %entry ], [ %add.us, %for.cond.for.cond.cleanup_crit_edge.us ]
