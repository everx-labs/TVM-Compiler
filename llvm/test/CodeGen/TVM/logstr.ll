...
define void @test_printstr(i64 %x) {
; CHECK: LOGSTR test_printstr
; CHECK: PRINTSTR 123456789098765
  tail call void @llvm.tvm.printstr(i8* getelementptr inbounds ([22 x i8], [22 x i8]* @.str, i64 0, i64 0))
  ret void
}
